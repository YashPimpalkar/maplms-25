...
const TheoryAttainment = ({ columnsData, userCourseId,  selectedCurriculumId }) => {
    // Step 1: Group cosnames and calculate their average percentage
        ...
        <table className="min-w-full border-collapse border border-gray-300">
          <thead>
            <tr className="bg-gray-100 text-left">
              <th className="border border-gray-300 px-4 py-2 text-center">Average Attainment</th>
          ...
          <tbody>
            {distinctCosnames.map((cos, index) => (
              <tr key={index}>
                <td className="border border-gray-300 px-4 py-2">{cos.cosname}</td>
                <td className="border border-gray-300 px-4 py-2">{cos.averagePercentage}%</td>
                <td className="border border-gray-300 px-4 py-2">{cos.categorization}</td>
              </tr>
            ))}
          </tbody>
        </table>
  ...
  export default TheoryAttainment;
